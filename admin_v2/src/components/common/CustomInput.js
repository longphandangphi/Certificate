...
import { DropdownItem, InputGroup, InputGroupButtonDropdown, DropdownToggle, DropdownMenu } from "reactstrap";
            ...
            <DropdownMenu>
              {isOpen &&
                ...
                dataDropdown.map(dropdownItem => {
                  return (
                    <DropdownItem key={dropdownItem.id} onClick={() => dropdownItemSelected(dropdownItem)}>
                      {dropdownItem.name}
                    </DropdownItem>
                  );
                })}
