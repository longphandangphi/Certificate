...
{
    public class ExtracurricularOfStudentViewModel
    {
        public ExtracurricularOfStudentViewModel()
        {

        }

        public ExtracurricularOfStudentViewModel(Extracurricular extracurricular) : this()
        {
